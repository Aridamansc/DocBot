...
def response_generator(query):
    ...
    # output['image'] = ['.download.jpeg']
    
    output={
        'output':"For Yamaha bikes, it's generally recommended to change the motor oil every 3,000 to 6,000 miles or every six months, whichever comes first. However, this can vary depending on the specific model of your Yamaha bike, how often you ride it, and the conditions in which you ride. It's always best to refer to the owner's manual for your specific model for the manufacturer's recommended maintenance schedule.",
        'intermediate':'''Thought: "I need to maintain my Yamaha bike properly to ensure its longevity and optimal performance.
        "Action: Schedule regular oil changes according to the recommended interval in the owner's manual, typically every 3,000 to 6,000 miles or every six months, whichever comes first.''',
        'image':['yes.jpg']
    }
    return output
